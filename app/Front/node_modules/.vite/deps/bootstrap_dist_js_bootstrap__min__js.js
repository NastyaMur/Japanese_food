...
var require_bootstrap_min = __commonJS({
  "node_modules/bootstrap/dist/js/bootstrap.min.js"(exports, module) {
    !function(t, e) {
      ...
      class Mt extends V {
        constructor(t2, e2) {
          super(t2, e2), this._popper = null, this._parent = this._element.parentNode, this._menu = U.findOne(kt, this._parent), this._inNavbar = this._detectNavbar();
        }
        static get Default() {
          return Pt;
        }
        ...
        static dataApiKeydownHandler(t2) {
          ...
          if (e2 && !i2)
            return;
          t2.preventDefault();
          const n2 = U.findOne(Et, t2.delegateTarget.parentNode), o2 = Mt.getOrCreateInstance(n2);
          if (s2)
      ...
      class Pe extends V {
        constructor(t2, e2) {
          ...
          super(t2, e2), this._isEnabled = true, this._timeout = 0, this._isHovered = false, this._activeTrigger = {}, this._popper = null, this._templateFactory = null, this._newContent = null, this.tip = null, this._setListeners();
        }
        static get Default() {
          return De;
        }
        ...
        show() {
          ...
          this._queueCallback(() => {
            ...
            this._isHovered = false, $.trigger(this._element, this.constructor.eventName("shown")), t3 && this._leave();
      ...
      b(je);
      const $e = "click.bs.scrollspy", Fe = "active", ze = "[href]", He = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: false, target: null }, qe = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element" };
      class Be extends V {
        constructor(t2, e2) {
        ...
        _configAfterMerge(t2) {
          return t2.target = c(t2.target) || document.body, t2;
        }
